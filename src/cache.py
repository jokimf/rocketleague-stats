...
class Dashboard:
    ...
    def reload(self) -> None:
        ...
        self.streaks_record = self.s.generate_streaks_record_page()
        ...
        self.days_since_first = self.q.days_since_first()
        ...
        self.profile_streaks = [self.s.generate_profile_streaks(p) for p in [0, 1, 2]]
